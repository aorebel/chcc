...
<!DOCTYPE html>
	...
	<body>
		...
		if(empty($info)){		
			...
			$uname = preg_replace('/-/', '', $info['student_id']);
			//$pLength = 10;
			//$cLength = 6;
			$password = randomPass();
			$code = randomCode();
			...
			if(!empty($duRow)){
				echo "This student ID is already registered. If you forgot your password please go to forget password on the login tab.";
			}else{
				$new = "yes";
				...
				<div class="w3-modal-content w3-card-4 w3-animate-zoom w3-padding w3-panel w3-red">
				    <h3>Error!</h3>
				    <p>Email cannot be sent please ask your website administrator for assistance regarding your login details.</p>
