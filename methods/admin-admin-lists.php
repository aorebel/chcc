...
<body>
    <div id="test-list">
    <input class="w3-input w3-border w3-padding" type="text" placeholder="Search for Employee ID or Last Name" id="myInput3" onkeyup="showAdmin()">
     
        <table class="w3-table-all w3-margin-top list" id="myTable3">
            ...
            if (str == "") {
                ...
                xmlhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        document.getElementById("myTable3").innerHTML = this.responseText;
                    }
                };
                xmlhttp.open("GET","../app/searchAdmin.php?q="+str,true);
                xmlhttp.send();
