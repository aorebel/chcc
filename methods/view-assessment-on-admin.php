...
$lx = $y1."".$s1."00000001";
$code = $lx+$assRow['id'];
$lecunit = $assRow['units']-($assRow['lab_units']*3);
...
<div id="aForm" class="w3-padding" style="width: 100%; ">
	...
	<div class="w3-row w3-padding infoTable">
		...
		<div class="w3-col s2 w3-right dot-border" style="margin-top: 20px; margin-right: 5px; padding-left: 10px; padding-right: 5px;">
			<p class="verdana">
				...
				<span class="width-20 right bold i text-right"><?php echo $lecunit+($assRow['lab_units']*2); ?></span><br>
	...
	<div class="w3-row w3-padding subjTable dot-border " style="margin-top: -20px; margin-bottom: 10px;">
		...
		<?php 
			$page = "";
			showStudentSubjects($conn, $sid, $sy, $sem, $page);
		...
		<div class="w3-col s7">
			<table class="verdana dot-border" style="width: 100%">
				...
				<tr class="top-5">
					...
					<td class="width-30">PHP <?php echo $assRow['lec_fee']/$lecunit?>.00</td>
					<td class="width-10 w3-center"><?php echo $lecunit; ?></td>
...
<script>
function printAss(){
    var printContents = document.getElementById('aForm').innerHTML;
